 ...
 */
class getBurgerRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\BurgerRepository' shared autowired service.
     *
     * @return \App\Repository\BurgerRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'BurgerRepository.php';

        return $container->privates['App\\Repository\\BurgerRepository'] = new \App\Repository\BurgerRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
