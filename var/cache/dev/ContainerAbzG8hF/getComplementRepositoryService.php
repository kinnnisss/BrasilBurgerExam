 ...
 */
class getComplementRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ComplementRepository' shared autowired service.
     *
     * @return \App\Repository\ComplementRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ComplementRepository.php';

        return $container->privates['App\\Repository\\ComplementRepository'] = new \App\Repository\ComplementRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
