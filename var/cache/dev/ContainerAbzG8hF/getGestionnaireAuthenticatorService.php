 ...
 */
class getGestionnaireAuthenticatorService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Security\GestionnaireAuthenticator' shared autowired service.
     *
     * @return \App\Security\GestionnaireAuthenticator
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Security'.\DIRECTORY_SEPARATOR.'GestionnaireAuthenticator.php';

        return $container->privates['App\\Security\\GestionnaireAuthenticator'] = new \App\Security\GestionnaireAuthenticator(($container->services['router'] ?? self::getRouterService($container)));
    }
}
