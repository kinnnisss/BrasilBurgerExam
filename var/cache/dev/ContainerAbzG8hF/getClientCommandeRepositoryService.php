 ...
 */
class getClientCommandeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ClientCommandeRepository' shared autowired service.
     *
     * @return \App\Repository\ClientCommandeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ClientCommandeRepository.php';

        return $container->privates['App\\Repository\\ClientCommandeRepository'] = new \App\Repository\ClientCommandeRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
