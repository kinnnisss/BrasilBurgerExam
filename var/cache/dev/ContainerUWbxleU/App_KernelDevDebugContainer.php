...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\BurgerController' => 'getBurgerControllerService',
            'App\\Controller\\ClientController' => 'getClientControllerService',
            'App\\Controller\\CommandeController' => 'getCommandeControllerService',
            'App\\Controller\\ComplementController' => 'getComplementControllerService',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('s77JqBdzJy', 0, (\dirname(__DIR__, 3).''.\DIRECTORY_SEPARATOR.'share'.\DIRECTORY_SEPARATOR.'dev/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('faCwueP4pN', 0, (\dirname(__DIR__, 3).''.\DIRECTORY_SEPARATOR.'share'.\DIRECTORY_SEPARATOR.'dev/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('lN5wZdNATo', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        return $container->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Xl14Duup6h', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\BurgerController', 'App\\Controller\\ClientController', 'App\\Controller\\CommandeController', 'App\\Controller\\ComplementController', 'App\\Controller\\DashboardController', 'App\\Controller\\HomeController', 'App\\Controller\\LivraisonController', 'App\\Controller\\MenuController', 'App\\Controller\\SecurityController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    {
        return $container->privates['cache.asset_mapper'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('cX-ZWqS0DE', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('Iwc89tcP8H', 0, (\dirname(__DIR__, 3).''.\DIRECTORY_SEPARATOR.'share'.\DIRECTORY_SEPARATOR.'dev/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    ...
    {
        return $container->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Wj6SANf6uO', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        return $container->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('wzHYVvureK', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        return $container->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Vl8DLW+TAG', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    protected static function getDoctrine_Orm_DefaultConfigurationService($container)
    {
        ...
        $instance->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Repository\\BurgerRepository' => ['privates', 'App\\Repository\\BurgerRepository', 'getBurgerRepositoryService', true],
            'App\\Repository\\ClientCommandeRepository' => ['privates', 'App\\Repository\\ClientCommandeRepository', 'getClientCommandeRepositoryService', true],
            ...
            'App\\Repository\\ComplementRepository' => ['privates', 'App\\Repository\\ComplementRepository', 'getComplementRepositoryService', true],
            'App\\Repository\\GestionnaireRepository' => ['privates', 'App\\Repository\\GestionnaireRepository', 'getGestionnaireRepositoryService', true],
            ...
            'App\\Repository\\QuartierRepository' => ['privates', 'App\\Repository\\QuartierRepository', 'getQuartierRepositoryService', true],
            ...
            'App\\Repository\\BurgerRepository' => '?',
            'App\\Repository\\ClientCommandeRepository' => '?',
            'App\\Repository\\ClientRepository' => '?',
            'App\\Repository\\CommandeRepository' => '?',
            'App\\Repository\\ComplementRepository' => '?',
            ...
            'App\\Repository\\QuartierRepository' => '?',
    ...
    {
        $container->privates['monolog.handler.main'] = $instance = new \Monolog\Handler\StreamHandler((\dirname(__DIR__, 4).'/var/log/dev.log'), 'debug', true, NULL, false);
    ...
    protected static function getSecurity_ContextListener_0Service($container)
    {
        return $container->privates['security.context_listener.0'] = new \Symfony\Component\Security\Http\Firewall\ContextListener(($container->privates['security.untracked_token_storage'] ??= new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage()), new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['security.user.provider.concrete.gestionnaire_provider'] ?? $container->load('getSecurity_User_Provider_Concrete_GestionnaireProviderService'));
    ...
    protected static function getTwigService($container)
    {
        ...
        $instance->addGlobal('client_app_url', $container->getEnv('CLIENT_APP_URL'));
    ...
    private function getDynamicParameter(string $name)
    {
        ...
        $value = match ($name) {
            ...
            'client_app_url' => $container->getEnv('CLIENT_APP_URL'),
